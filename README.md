...
Estes arquivos garantem a correta pinagem e funcionalidade da sua placa ESP32-A1S Audio Kit v2.2 (AI Thinker).

Baixe os arquivos customizados do repositório:

 🔗 https://github.com/viniciusmbs/audio_board/tree/main

Dentro desse repositório você encontrará os seguintes arquivos:
...
board_def.h  
board_pins_config.c  
Copie esses arquivos para a pasta abaixo, substituindo os existentes:

swift
Copiar
Editar
~/esp/esp-adf/components/audio_board/lyrat_v4_3/
📌 Importante: Essa substituição é essencial para que o ESP-ADF reconheça corretamente a pinagem da sua placa AI Thinker v2.2 e funcione com o projeto VoIP.
